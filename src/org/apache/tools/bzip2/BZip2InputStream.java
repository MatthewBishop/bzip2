 ...
 * possible, to force <code>BZip2InputStream</code> to release the
 * allocated memory.  See {@link CBZip2OutputStream
 * CBZip2OutputStream} for information about memory usage.</p>
 *
 * <p><code>BZip2InputStream</code> reads bytes from the compressed
...
public class BZip2InputStream extends InputStream {
    ...
    /**
     * Constructs a new BZip2InputStream which decompresses bytes read from
    ...
    /**
     * Constructs a new BZip2InputStream which decompresses bytes
    ...
    private void initBlock() throws IOException {
        ...
        if (magic0 != 0x31 || // '1'
            ...
            int storedBlockCRC = bsGetInt();
            boolean blockRandomised = bsR(1) == 1;
            
            if (blockRandomised)
                throw new IOException("PANIC! RANDOMISED BLOCK!");
    ...
    private boolean complete() throws IOException {
        int storedCombinedCRC = bsGetInt();
        this.currentState = EOF;
        this.data = null;
